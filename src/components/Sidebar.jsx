...
const Sidebar = () => {
  ...
  return (
    <aside className="md:w-1/3 lg:w-1/5 xl:w-1/6 px-5 py-10 border-r-2 border-gray-300">
      <div className="flex items-center">
        <div className="shrink-0">
          <img
            src="https://media-exp1.licdn.com/dms/image/C4E03AQFYUMpJ16rw5A/profile-displayphoto-shrink_200_200/0/1587243282946?e=1653523200&v=beta&t=8-kB6o41lyZlZGvkHoyJx_XPLqmAVPink-EmpPbKoyU"
    ...
    // <aside className="md:w-1/3 lg:w-1/5 xl:w-1/6 px-5 py-10 border-r-2">
    ...
    //         </div>
    //         <div className="grow ml-3">
    //           <p className="text-sm font-semibold text-blue-600">Hola: {auth.nombre}</p>
    //         </div>
    //       </div>
    //     </a>
    //   </div>
